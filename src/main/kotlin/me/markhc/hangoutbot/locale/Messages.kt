...
object Messages {
    ...
    private val JOIN_MESSAGE_CHOICES = listOf(
        ...
        "%name% I\u0027m going to have to ask you a very serious question... do you pronounce C# " +
            "like C-hashtag... DO YOU!?! Because we do NOT need another one of those people.",
        ...
        "My name is %name%, Commander of the coders of the North, General of the IDE legions, loyal servant to the true emperor, Open Source. Owner to an unfinished project, partner to an idea waiting to be started. And I will have my vengeance, in this life or the next.",
        "git blame %name%",
       ...
       "%name%, the question isn\u0027t how... but when...",
        ...
        "You were the chosen one! It was said you would destroy TPH, not join them! You were my sibling, %name%, I loved you!",
        ...
        "Give %name% a fire and they're warm for a day. But set fire to them and they're warm for the rest of their life!",
